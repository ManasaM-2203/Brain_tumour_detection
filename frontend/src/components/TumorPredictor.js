  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <a href="#" style={{ color: "#fff", textDecoration: "none", fontSize: "15px" }}>Home</a>
        <a href="#" style={{ color: "#aaa", textDecoration: "none", fontSize: "15px" }}>Symptoms</a>
        <a href="#" style={{ color: "#aaa", textDecoration: "none", fontSize: "15px" }}>Process of detection</a>
      </nav>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <img 
              ...
              onError={(e) => {
                e.target.src = "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=500";
              }}
            />
          </div>
          <style>{`
          ...
          <form onSubmit={handleSubmit} style={{
            ...
            <button
              ...
              style={{
                ...
                boxShadow: loading || !selectedFile ? "none" : "0 4px 15px rgba(40, 167, 69, 0.3)",
                transition: "all 0.3s ease"
              }}
            >
          ...
          {classification && (
            <div style={{
              ...
              <p style={{
                ...
                Confidence: <strong style={{ color: "#28a745" }}>{confidence}%</strong>
              </p>
